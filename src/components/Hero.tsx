...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      ref={heroRef}
      className="relative h-[85dvh] lg:h-[60vh] w-full flex items-center overflow-hidden bg-gradient-to-r from-primary via-pink-500 to-primary"
    >
      <div className="grid lg:grid-cols-2 gap-8 w-full max-w-6xl mx-auto h-full items-center px-4 lg:px-4 md:px-0">
        {/* Left Content */}
        <div
          className={`flex flex-col justify-center items-center lg:items-end text-center lg:text-right h-full transition-all duration-1000 relative ${
        ...
        >
          {isMobile && (
            <div className="absolute inset-0 bg-gradient-to-r from-primary/80 via-pink-500/80 to-primary/80"></div>
          )}
          ...
          <p className="text-lg lg:text-xl text-white mb-6 max-w-lg mx-auto lg:mx-0 text-center lg:text-right leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-6">
              ...
              <Button
                size="lg"
                variant="outline"
                className="btn-outline rounded-full px-6 py-3 text-lg font-semibold"
      ...
      {!isMobile && (
        <div
          className={`h-full w-full flex items-center justify-center transition-all duration-1000 delay-300 ${
            isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"
          }`}
        >
          <img
