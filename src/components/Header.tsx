...
const Header = () => {
  ...
  const handleNavClick = (href: string, e?: React.MouseEvent) => {
    ...
    if (href === '#courses') {
      navigate('/?tab=courses#offerings');
    } else if (href === '#workshops') {
      navigate('/?tab=workshops#offerings');
    } else if (href === '#packs') {
      navigate('/?tab=packs#offerings');
    }
  };
    ...
    <>
      ...
      <header className="w-full bg-white/95 backdrop-blur-md border-b border-border sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 py-4">
         ...
         <div className="flex items-center justify-between w-full lg:flex-none lg:flex-initial relative">
  {/* Menu Icon (Left on Mobile) */}
 ...
 {/* Centered Logo */}
  ...
  >
    <UserCircle className="w-6 h-6 text-pink-500" />
            ...
            <div className="flex items-center gap-4 lg:flex-none lg:justify-end">
              {/* Mobile Menu Sidebar */}
