        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#courses" className="text-white/80 hover:text-white transition-colors">الدورات</a></li>
              <li><a href="#workshops" className="text-white/80 hover:text-white transition-colors">الورشات</a></li>
