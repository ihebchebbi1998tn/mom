...
const ChallengeCard = ({ challenge, onEdit, onDelete, onManageVideos }: ChallengeCardProps) => {
  ...
  return (
    <Card className="card-elegant overflow-hidden hover:shadow-lg transition-shadow">
      <CardContent className="p-6">
        ...
        <h3 className="text-xl font-bold text-foreground mb-2" dir="rtl">{challenge.title}</h3>
        <p className="text-sm text-muted-foreground mb-4 line-clamp-2" dir="rtl">{challenge.description}</p>
