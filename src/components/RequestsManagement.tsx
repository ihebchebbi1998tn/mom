    ...
    <div className="space-y-6" dir="ltr">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-1 sm:grid-cols-3 h-auto">
          <TabsTrigger value="packs" className="flex items-center justify-center gap-2 py-3">
            <Package className="w-4 h-4" />
            <span className="text-sm sm:text-base">Packs/Cours ({filteredRequests.length})</span>
          </TabsTrigger>
          <TabsTrigger value="workshops" className="flex items-center justify-center gap-2 py-3">
            <Dumbbell className="w-4 h-4" />
            <span className="text-sm sm:text-base">Ateliers ({filteredWorkshops.length})</span>
          </TabsTrigger>
          <TabsTrigger value="challenges" className="flex items-center justify-center gap-2 py-3">
            <Target className="w-4 h-4" />
            <span className="text-sm sm:text-base">Défis ({filteredChallenges.length})</span>
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="challenges" className="space-y-4 mt-4">
          {filteredChallenges.length === 0 ? (
            ...
            filteredChallenges.map((request) => (
              <Card key={request.id}>
                <CardContent className="p-4">
