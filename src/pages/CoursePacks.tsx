                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="space-y-3 mt-auto">
                      {/* Admin Access or Buy Button */}
                      {currentUser?.role === 'admin' ? (
                        <Button
                          onClick={() => handleViewPack(pack.id)}
                          className="w-full py-6 text-lg font-bold bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white shadow-lg hover:shadow-xl transition-all duration-300"
                        >
